	...
	private class ListenerTable implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			try {
				...
				boolean flag = AlunoControler.getInstance().verificaMatricula(matricula);
				
				if(flag){
					Aluno aluno = (AlunoControler.getInstance().mostraAluno(matricula));
					int matriculaMostra = aluno.getMatricula();
					String nome = aluno.getNome();
					String curso = aluno.getCurso();
					int livrosLocados = aluno.getLivrosLocados();
					
					mostaNome.setText(nome);
					mostraCurso.setText(curso);
